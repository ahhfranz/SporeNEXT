...
import './UnlinkDiscordModal.css';

const UnlinkDiscordModal = ({ isOpen, onClose, onConfirm }) => {
  const { t } = useLanguage();
      ...
      <div className="unlink-modal" onClick={(e) => e.stopPropagation()}>
        <div className="unlink-modal-content-row">
          ...
          <div className="unlink-modal-details">
            ...
            <p className="unlink-modal-text">{t('settings.discordUnlinkConfirm')}</p>
            <div className="unlink-modal-buttons">
              ...
              <button className="unlink-modal-btn confirm" onClick={onConfirm}>
                {t('settings.unlinkDiscordBtn') || 'Unlink'}
              </button>
            </div>
          </div>
        </div>
...
export default UnlinkDiscordModal;
